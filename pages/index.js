...
export default function Home() {
  return (
    <div>
      <Head>
        <title>CyberShop-For fashion lover Boys</title>
        <meta name="description" content="CyberShop-For fashion lover Boys" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <span className='flex '>
        <Image src="/home.jpg" alt="" srcSet="" width={2500} height={800} />
      </span>
           <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
              <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
                <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">CyberShop-For fashion lover Boys</h1>
                <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Letest Brand and Products Aveliable here </p>
                <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Letest Brand and Products Aveliable here </p>
                <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Letest Brand and Products Aveliable here </p>
              </div>
